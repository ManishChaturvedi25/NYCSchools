...
class NYCSchoolListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        viewModel = NYCSchoolListViewModel(self)
    ...
    func startAnimation(){
        if (self.isAnimating == false){
            ...
            self.alertController = Utils.getAlertController("Fetching Schools…")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let school = sender as? NYCSchool {
            let detailsView = segue.destination as? NYCSchoolDetailViewController
...
extension NYCSchoolListViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: NYCSchoolTableViewCell.identifier) as! NYCSchoolTableViewCell
...
extension NYCSchoolListViewController: UITableViewDelegate {
...
extension NYCSchoolListViewController: SchoolListViewControllerDelegate {
